...
$(window).on('load', function () {
  card_slide = [
    {
      ...
      marine_image: './assets/images/marine-life-01-1x.jpg',
    },
    {
      marine_name: '흰둥가리',
      marine_explanation: '애니메이션(’니모를찾아서’)에 등장해 유명해진 흰동가리! 인도•태평양: 홍해, 동아프리카, 하와이에 주로 서식하고 있어요~',
      marine_image: './assets/images/marine-life-02-1x.jpg',
    },
    {
      marine_name: '가든일',
  ...
  card_slide.forEach((item, index) => {
    ...
    $(card).find('img').attr('src', item.marine_image);
